...
<body>
    <div class="setup-container">
        ...
        <form method="POST">
            ...
            <button type="submit" name="set_email" class="btn" aria-label="Save email address and continue">Save Email Address</button>
        </form>

        <div class="skip-link">
            <a href="/user-portal/" aria-label="Skip email setup for now">Skip for now (not recommended)</a>
        </div>
        <?php endif; ?>
    </div>
