<?php
/**
 * FlexPBX User Portal - Notification Settings
...
<head>
    ...
    <title>Notification Settings - FlexPBX</title>
    <style>
...
<body>
            ...
            <div class="setting-group">
                <div class="setting-header">
                    ...
                    <label class="toggle-switch">
                        <input type="checkbox" id="push-enabled" onchange="togglePushNotifications(this.checked)" aria-label="Toggle push notifications">
        ...
        <div class="card">
            ...
            <div class="setting-group">
                <div class="setting-header">
                    ...
                    <label class="toggle-switch">
                        <input type="checkbox" id="email-enabled" onchange="updatePreference('email_notifications_enabled', this.checked)" aria-label="Toggle email notifications">
                        <span class="slider"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="setting-group">
                <div class="setting-header">
                    <div>
                        ...
                        <div class="setting-description">Get notified when you receive a new voicemail</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" id="notify-voicemail" onchange="updatePreference('notify_voicemail', this.checked)" aria-label="Toggle voicemail notifications">
                        <span class="slider"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="setting-group">
                <div class="setting-header">
                    <div>
                        ...
                        <div class="setting-description">Get notified about missed calls</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" id="notify-missed-calls" onchange="updatePreference('notify_missed_calls', this.checked)" aria-label="Toggle missed call notifications">
                        <span class="slider"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="setting-group">
                <div class="setting-header">
                    <div>
                        ...
                        <div class="setting-description">Get notified when your extension registers/unregisters</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" id="notify-sip-status" onchange="updatePreference('notify_sip_status', this.checked)" aria-label="Toggle SIP status change notifications">
                        <span class="slider"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="setting-group">
                <div class="setting-header">
                    <div>
                        ...
                        <div class="setting-description">Get notified when you login to the web dashboard</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" id="notify-login" onchange="updatePreference('notify_login', this.checked)" aria-label="Toggle login notifications">
                        <span class="slider"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="setting-group">
                <div class="setting-header">
                    <div>
                        ...
                        <div class="setting-description">Get notified when you logout from the web dashboard</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" id="notify-logout" onchange="updatePreference('notify_logout', this.checked)" aria-label="Toggle logout notifications">
                        <span class="slider"></span>
                    </label>
                </div>
            </div>
    ...
    <script>
        ...
        async function loadPreferences() {
            try {
                const response = await fetch(`/api/notification-subscribe.php?action=get_preferences&identifier=${extension}&account_type=user`);
        ...
        async function checkStatus() {
            try {
                const response = await fetch(`/api/sip-status.php?extension=${extension}`);
                const data = await response.json();
