...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    configureSounds: (options) => ipcRenderer.invoke('configure-sounds', options),
    playConnectionSound: () => ipcRenderer.invoke('play-connection-sound'),
    playDisconnectSound: () => ipcRenderer.invoke('play-disconnect-sound'),
    playDoorClosingSound: () => ipcRenderer.invoke('play-door-closing-sound'),
    playLogoutSound: () => ipcRenderer.invoke('play-logout-sound'),
    playSessionEndSound: () => ipcRenderer.invoke('play-session-end-sound'),
    playMessageSendSound: () => ipcRenderer.invoke('play-message-send-sound'),
    playMessageReceiveSound: () => ipcRenderer.invoke('play-message-receive-sound'),
