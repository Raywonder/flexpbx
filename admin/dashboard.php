...
$page_title = 'FlexPBX Admin Dashboard';
    ...
    <div class="container">
        <div class="quick-stats">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: <?php echo htmlspecialchars($_SESSION['network_color'] ?? '#ff6b6b'); ?>;">
                    <?php echo $_SESSION['network_trusted'] ? 'Secure' : 'Public'; ?>
                </div>
                <div class="stat-label"><?php echo htmlspecialchars($_SESSION['network_name'] ?? 'Unknown'); ?></div>
            </div>

            <div class="stat-card">
                <h3>Your IP Address</h3>
                <div class="stat-value" style="font-size: 1.2rem; color: #333;">
                    <?php echo htmlspecialchars($_SESSION['client_ip'] ?? 'Unknown'); ?>
                </div>
                <div class="stat-label">
                    <?php if (!empty($_SESSION['public_ip'])): ?>
                        Public: <?php echo htmlspecialchars($_SESSION['public_ip']); ?>
                    <?php else: ?>
                        Private network
                    <?php endif; ?>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value" style="font-size: 1.2rem; color: #333;">
                    <?php echo $_SESSION['network_trusted'] ? '30 Days' : '24 Hours'; ?>
                </div>
                <div class="stat-label">Auto-logout timer</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-label">Role: <?php echo htmlspecialchars($admin_role); ?></div>
            </div>
        </div>
        ...
        <div class="search-quick-actions" style="background: white; border-radius: 12px; padding: 25px; margin-bottom: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.2);">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    ...
                    <a href="setup-email.php" class="btn" style="text-align: center; background: linear-gradient(135deg, #95a5a6 0%, #7f8c8d 100%);">Update Email</a>
                    <a href="link-extension.php" class="btn" style="text-align: center; background: linear-gradient(135deg, #4ade80 0%, #22c55e 100%);">Link Extension</a>
                </div>
            </div>
        ...
        <div style="text-align: center; margin-top: 40px; padding: 20px;">
            ...
            <p style="color: white; opacity: 0.7; font-size: 0.9em; margin-top: 10px;">
...
<!-- Dashboard Search and Enhancement Script -->
<script>
(function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        cards.forEach(card => {
            ...
            const searchText = `${title} ${desc} ${href}`;
        ...
        sections.forEach(section => {
            const nextElement = section.nextElementSibling;
            if (nextElement && nextElement.classList.contains('grid')) {
                const visibleCards = Array.from(nextElement.querySelectorAll('.card')).filter(card =>
                    card.style.display !== 'none'
                );
