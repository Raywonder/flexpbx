...
.back-btn { display: inline-block; background: #667eea; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; margin: 10px 0; }
</style>
</head><body>
<div class="container">
...
<strong>Auto-fixes Applied:</strong> ' . $this->fixes_applied . '
        ...
        $html .= '<a href="dashboard.html" class="back-btn">← Back to Dashboard</a>';
        $html .= '</div>';
        $html .= '</div></body></html>';
        return $html;
    }
