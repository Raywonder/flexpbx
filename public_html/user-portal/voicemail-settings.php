    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn">Save Feature Settings</button>
            </form>
        </div>
        ...
        <div class="card">
            ...
            <div class="action-buttons">
                <button class="btn" onclick="alert('Call *97 from your phone to access voicemail')">Access Voicemail</button>
                <button class="btn btn-secondary" onclick="alert('Web-based message player coming soon!')">Play Messages (Coming Soon)</button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="action-buttons">
                <a href="my-recordings.php" class="btn">Upload Custom Greetings</a>
                <button class="btn btn-secondary" onclick="alert('Call *97 then press 0 to record greetings by phone')">Record by Phone</button>
            </div>
        </div>
