...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="status-box" id="sip-status-box">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div>
                        <span class="status-indicator status-offline" id="status-indicator"></span>
                        <span id="status-text">Checking...</span>
                    </div>
                    <button onclick="checkStatus()" class="btn" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Refresh</button>
                </div>
                <div id="status-details" style="margin-top: 1rem; font-size: 0.9rem; color: #666; display: none;"></div>
            </div>
        </div>
