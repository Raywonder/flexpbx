    ...
    <div class="container">
        <div class="card">
            ...
            <div class="info-box">
                ...
                <ul>
                    <li><strong>On your phone:</strong> Use voice recorder app</li>
                    <li><strong>On computer:</strong> Use QuickTime, Audacity, or online recorder</li>
                    <li><strong>Or dial *97:</strong> Record directly via phone (coming soon!)</li>
                </ul>
            </div>
