...
<body>
    <div class="container">
        ...
        <div class="signup-box">
            ...
            <section aria-labelledby="signup-confirmed-heading">
                <h2 id="signup-confirmed-heading" style="margin-bottom: 1rem; color: #155724;">Sign-up confirmed</h2>
                <p>Your extension account was created and the next setup instructions were sent by email.</p>
                <p>Open that email, use the secure password setup link, then sign in with your email address, username, or extension. If you are using Flex Phone, return to the app after opening the confirmation link and choose Finish sign in.</p>
                <p>If the email does not arrive within a few minutes, check spam or contact support.</p>
            </section>
            <?php else: ?>
            <form method="POST">
                <div class="form-group">
    ...
    <script>
        ...
        async function suggestExtension() {
            ...
            try {
                const response = await fetch('/api/extension-availability.php?action=suggest');
        ...
        if (signupForm) {
            signupForm.addEventListener('submit', function(e) {
                ...
                if (!extensionAvailable && !/^\d{4}$/.test(extension)) {
                    e.preventDefault();
